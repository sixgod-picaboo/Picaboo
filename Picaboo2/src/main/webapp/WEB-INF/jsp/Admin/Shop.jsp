        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-qrcode"></i>店铺审核</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
				...
				<div class="form-group">
						<label for="titleLike">店铺名：</label> <input type="text"
							class="form-control" id="titleLike" name="titleLike"
							value="${sessionScope.titleLike}" placeholder="请输入要查询的店铺名">
					</div>
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						<tbody id="tbody">
							<c:forEach items="${sessionScope.pd.data}" var="shop">
								<tr>
									<td><input type="checkbox" value="${shop.shop_id}" style="width:20px;height:20px"/></td>
									<td>${shop.shop_name}</td>
									<td>${shop.shop_info}</td>
									<td><button type="button" class="btn btn-danger yes"
											value="${shop.shop_id}"><lable>通过</lable></button> <a
									...
									<td><button type="button" class="btn btn-danger on"
											value="${shop.shop_id}"><lable>不通过</lable></button> <a
										style="margin-left: 10px" id="modal-843654"
										href="#modal-container-843654" data-toggle="modal">
									</a></td>
								</tr>
		...
		$(function(){
			...
			$(".on").click(function(){
				if(confirm("是否确认执行此操作？")){
					location.href = "${pageContext.request.contextPath}/Review?oop=shop&op=on&id=" + $(this).val();
				}
			});
			...
			$(".yes").click(function(){
				if(confirm("是否确认执行此操作？")){
					location.href = "${pageContext.request.contextPath}/Review?oop=shop&op=yes&id=" + $(this).val();
				}
			});
			
			//模糊查询
			$("#like").click(function(){
				location.href = "${pageContext.request.contextPath}/Review?oop=shop&titleLike=" + $("#titleLike").val();
			});
