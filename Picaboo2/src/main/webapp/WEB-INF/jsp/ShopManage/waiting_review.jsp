						...
						<div class="col-md-6">
							...
							<div class="header-top-right text-center text-md-right">
								<ul class="header-top-menu">
									...
									<li><a href="${pageScope.basePath}ShopServlet?op=search">我的店铺</a></li>
									<li class="drodown-show"><a href="#">${user.user_name} <i
											class="ion-ios-arrow-down"></i></a> <!--Header Top Dropdown Start-->
										<ul class="ht-dropdown">
											<li><a href="${pageScope.basePath}my-account.jsp">个人账户</a></li>
											<li><a href="${pageScope.basePath}UserServlet?op=loginout" >登出</a></li>
										</ul> <!--Header Top Dropdown End-->
									</li>
									</c:when>
									<c:when test="${user.user_name == null}">
									<a href="${pageScope.basePath}login.jsp">您未登录,请登录</a>
									</c:when>
									</c:choose>
								</ul>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							<!--Logo Start-->
							<div class="logo">
								<a href="${pageScope.basePath}/index.jsp"> <img src="${pageScope.basePath}/img/logo/logo1.jpg" alt="">
								</a>
							</div>
							<!--Logo End-->
						</div>
							...
							<div class="header-menu-area">
								<nav>
									<ul class="main-menu">
										...
										<li><a href="${pageScope.basePath}/about.jsp">关于我们</a></li>
										<li><a href="${pageScope.basePath}/gs?op=queryByName">购物</a></li>
										<li><a href="${pageScope.basePath}/index.jsp">更多</a> <!--Dropdown Menu Start-->
											<ul class="dropdown">
												<li><a href="${pageScope.basePath}/about.jsp">关于我们</a></li>
												<li><a href="${pageScope.basePath}/gs?op=queryByName">购物</a></li>
												<li><a href="${pageScope.basePath}/contact.jsp">联系我们</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-lg-3 order-lg-3 order-2">
							<!--Mini Cart Start-->
							<div class="mini-cart">
								<a href="${pageScope.basePath}cart.jsp"> <span class="cart-info"> <span class="text">购物车</span>
								</span>
								</a>
				...
				<div class="row">
					<div class="col-12">
						<div class="breadcrumb-content text-center">
							<h1 class="breadmome-name">您申请的店铺正在审核中。。。</h1>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="col-lg-4 col-md-6 col-12">
								...
								<div class="single-footer-wiedget mb-30">
									<div class="footer-logo">
										<a href="${pageScope.basePath}/index.jsp"><img src="img/logo/logo1.jpg"
											alt=""></a>
									</div>
							...
							<div class="col-md-5">
								...
								<div class="tab-content product-details-large" id="myTabContent">
									...
									<div class="tab-pane fade" id="single-slide2" role="tabpanel"
										...
										<!--Single Product Image Start-->
										<div class="single-product-img img-full">
											<img src="${pageScope.basePath}/img/single-product/large/large2.jpg" alt="">
										</div>
										<!--Single Product Image End-->
									</div>
									<div class="tab-pane fade" id="single-slide3" role="tabpanel"
										...
										<!--Single Product Image Start-->
										<div class="single-product-img img-full">
											<img src="${pageScope.basePath}/img/single-product/large/large3.jpg" alt="">
										</div>
										<!--Single Product Image End-->
									</div>
									<div class="tab-pane fade" id="single-slide4" role="tabpanel"
										...
										<!--Single Product Image Start-->
										<div class="single-product-img img-full">
											<img src="${pageScope.basePath}/img/single-product/large/large4.jpg" alt="">
										</div>
										<!--Single Product Image End-->
									</div>
								</div>
									...
									<div class="nav single-slide-menu" role="tablist">
										...
										<div class="single-tab-menu img-full">
											<a data-toggle="tab" id="single-slide-tab-2"
												...
												src="${pageScope.basePath}/img/single-product/small/small2.jpg" alt=""></a>
										</div>
										<div class="single-tab-menu img-full">
											<a data-toggle="tab" id="single-slide-tab-3"
												href="#single-slide3"><img
												src="${pageScope.basePath}/img/single-product/small/small3.jpg" alt=""></a>
										</div>
										<div class="single-tab-menu img-full">
											<a data-toggle="tab" id="single-slide-tab-4"
												href="#single-slide4"><img
												src="${pageScope.basePath}/img/single-product/small/small4.jpg" alt=""></a>
										</div>
									</div>
								</div>
								<!--Modal Tab Menu End-->
	...
	<script type="text/javascript">
		$(function(){
			$.getJSON("${pageScope.basePath}gs?op=gy",null,function(data){
	        	...
	        	typelist=typelist+"<li class='rx-child'><a href='${pageScope.basePath}shop.html'>学习</a></li><li class='rx-parent'><a class='rx-default'><span class='cat-thumb  fa fa-plus'></span>更多</a><a class='rx-show'><span class='cat-thumb  fa fa-minus'></span>缩小</a></li>"
