				...
				<div class="row">
					<div class="col-12">
						<div class="breadcrumb-content text-center">
							<h1 class="breadmome-name">申请属于你的店铺吧！</h1>
							<ul>
								<li><a href="../index.jsp">首页</a></li>
								<li class="active">申请店铺</li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="login">
							<div class="login-form-container">
								<div class="login-form">
									<form action="${pageScope.basePath}ShopServlet?op=registered">
										<%
											Date d = new Date();
											SimpleDateFormat df = new SimpleDateFormat("yyyyMMddHHmmss");
											String now = df.format(d);
										%>
										<label>店铺ID</label> <input name="shop_id" type="text"
											readonly="readonly" value="<%=now%>"> 
										<label>用户ID</label>
										<c:if test="${sessionScope.user eq null}">
											<input name="user_id" type="text" readonly="readonly"
												value="null">
										</c:if>
										...
										<label>店铺名称</label> <input name="shop_name" type="text">
										<label>电话号码</label> <input name="shop_tel" type="text">
										<label>店铺地址</label> <input name="shop_addr" type="text">
										<input hidden="hidden" name="shop_level" type="text"
											readonly="readonly" value="3">
										<label>申请理由</label> <input name="shop_info" type="text">
										<div class="button-box">
											<button type="submit" class="default-btn">提交申请</button>
										</div>
									</form>
								</div>
							</div>
