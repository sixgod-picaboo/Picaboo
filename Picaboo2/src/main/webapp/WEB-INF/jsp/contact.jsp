		        ...
		        <div class="row">
		            <div class="col-12">
		                <div class="breadcrumb-content text-center">
                            <h1 class="breadmome-name">联系我们</h1>
		                    <ul>
		                        ...
		                        <div class="communication-info">
		                            ...
		                            <div class="single-communication">
		                                ...
		                                <div class="communication-text">
		                                    <span>Picaboo - 厦门六神科技有限公司 <br>中国</span>
		                                </div>
		                            </div>
		                            ...
		                            <div class="single-communication">
		                                ...
		                                <div class="communication-text">
		                                    <span>打给我们: <br><a href="">(400) 123 4567</a></span>
		                                </div>
		                            </div>
		                            <!--Single Communication End-->
                                    <!--Single Communication Start-->
		                            <div class="single-communication">
		                                ...
		                                <div class="communication-text">
		                                    <span>发邮件给我们: <br><a href="mailto:demo@hastech.com">demo@hastech.com</a></span>
		                                </div>
		                            </div>
		                            <!--Single Communication End-->
		                        </div>
		                        ...
		                        <div class="contact-form">
		                            ...
		                            <form id="contact-form" action="mail.php" method="post">
		                                <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="contact-form-style mb-20">
                                                    <input name="subject" placeholder="标题" type="text">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="contact-form-style">
                                                    <textarea name="message" placeholder="内容"></textarea>
                                                    <button class="default-btn" type="submit"><span>发送邮件</span></button>
                                                </div>
                                            </div>
		                                </div>
		                            </form>
